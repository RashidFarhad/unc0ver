 <?php
ob_start();
$API_KEY = "1386558426:AAFUOQyvO2z6pngZC3USEhExrKEoB9qwIXM";
$sudo = "890746179";
$admin = "890746179";
...
//••┉┉┉┉┉┉┉┉┉┉┉┉┉••//
$sudo = $sudo;
$username="RashidFarhadJoin_Bot"; //یوزرە نەمی بۆت
$tws = "SeeYouIOS"; // یوزرنەمی کەناڵ بێ @
$kna = "SeeYouIOS"; //یوزرنەمی کەناڵ بێ @
$SAEEDFiles = "$sudo"; //
$admin = "$sudo"; //
$botid ="1135491981";// ئایدی بۆت
$idBot = "$botid";
$ali = "@SeeYouIOS";// یوزرنەمی کەناڵ
$alii = "@SeeYouIOS";// یوزرنەمی کەناڵ
...
$Alsh = "TO"; 
if($text == "/start" or $text == "دەستپێکردن" or $text == "RashidOFF"){
$ali = "@ferkaribokurd11"; #یوزرنەمی کەناڵ
...
📟 ¦  جۆین چەناڵ بە تابتوانی بۆت بەکاربێنیت پاشان /start کە ،
🖲 ¦ چەناڵ ~⪼ $ali ،
▂ ",
...
'text'=>"
 ...
 ~ ئەمە بوتی پەیوەستکردنی چەناڵە بە گرووپەوە ❗️
~ سەرەتا بوتەکە لەگرووپ و چەنالەکەت بکە بە ئەدمین ❗️
~ ئینجا وشەی (SeeYouIOS) بنووسە لە گرووپەکەت بۆ چالاک کردنی بووت ❗️
~  وشەی (RashidOFF) بۆ ناچالاک بوونی بۆت ❗️

⏱┊‹ [$date $aa](https://t.me/SeeYouIOS)",
'parse_mode'=>"MarkDown",
'disable_web_page_preview' =>true,
'reply_markup'=>json_encode([
'inline_keyboard'=>[
...
- ~ ببورە بەرێزم ناتوانی چات بکەی تا جۆینی چەناڵ نەكەیت  🍁
- ~ئەگەر جۆین نەبیت چاتت ناکرێتەوە
-   چەناڵ [@$ch] 📡
...
'reply_markup'=>json_encode([
'inline_keyboard'=>[
    [['text'=>"کلیک لێرە بکە بۆ جۆینی چەناڵ 🔱",'url'=>"https://t.me/$ch"]]
]
])
]);return false;}}
...
if ($text == "SeeYouIOS" or $text == '/add' and  $you == "administrator") {
...
🗃 ¦ پاشان وشەی (SeeYouIOS) بنێرە لە گرووپ
ئەدمینی بۆت @SeeYouI0S
",
...
ئێستا چەناڵەکەتم پێبناسێنە بەم شێوازە 

~ یوزەنەیمی چەنالەکەت بنێرە بەبێ (@)
...
~ بەسەرکەوتوی پەیوەستکرا؛✅

- پێویستە  بوت لە چەناڵ و گرووپ ئەدمین بێت 👨‍✈️",
'parse_mode'=>"MarkDown",
'disable_web_page_preview' =>true,
]);
}
